...
INSERT INTO bank_app.clients (id, status, tax_code, first_name, last_name, date_of_birth, email, address, phone)
VALUES (UUID_TO_BIN('2c26dd1e-498c-11ee-bbf9-10d0e2fa4154'), 1, '321-12345-321', 'John', 'Doe', '2000-07-05', 'john.doe@example.com',
        'Alexanderplatz 7, 10178 Berlin', '+1234567890'),
       (UUID_TO_BIN('2c26e002-498c-11ee-bbf9-10d0e2fa4154'), 1, '123-12345-123', 'Alice', 'Johnson', '2001-08-05', 'alice.johnson@example.com',
        'Kurfürstendamm 216, 10719 Berlin', '+1234567999'),
       (UUID_TO_BIN('2c26e124-498c-11ee-bbf9-10d0e2fa4154'), 2, '123-34234-123', 'Michael', 'Smith', '2000-07-25', 'michael.smith@example.com',
        'Marienplatz 22, 80331 München', '+9876543210'),
       (UUID_TO_BIN('2c26e1c4-498c-11ee-bbf9-10d0e2fa4154'), 2, '123-12345-123', 'Emily', 'Brown',  '1998-01-05', 'emily.brown@example.com',
        'Unter den Linden 77, 10117 Berlin', '+4444444444'),
       (UUID_TO_BIN('2c26e246-498c-11ee-bbf9-10d0e2fa4154'), 1, '123-12345-123', 'David', 'Wilson', '1998-01-01',  'david.wilson@example.com',
        'Heerstraße 12, 14052 Berlin', '+5555555555'),
       (UUID_TO_BIN('2c26e2d2-498c-11ee-bbf9-10d0e2fa4154'), 1, '123-12345-123', 'Sophia', 'Miller', '1998-02-27', 'sophia.miller@example.com',
        'Schlossplatz 1, 70173 Stuttgart', '+6666666666'),
       (UUID_TO_BIN('2c26e354-498c-11ee-bbf9-10d0e2fa4154'), 3, '123-12345-123', 'James', 'Anderson', '1998-03-27', 'james.anderson@example.com',
        'Friedrichstraße 96, 10117 Berlin', '+7777777777'),
       (UUID_TO_BIN('2c26e3d6-498c-11ee-bbf9-10d0e2fa4154'), 3, '123-12345-123', 'Olivia', 'Martinez', '1995-02-27', 'olivia.martinez@example.com',
        'Am Zirkus 1, 10117 Berlin', '+8888888888'),
       (UUID_TO_BIN('2c26e462-498c-11ee-bbf9-10d0e2fa4154'), 1, '123-12345-123', 'Alexander', 'Lee', '1998-02-12',  'alexander.lee@example.com',
        'Goethestraße 25, 60313 Frankfurt am Main', '+1234567890'),
       (UUID_TO_BIN('2c26e4ee-498c-11ee-bbf9-10d0e2fa4154'), 1, '123-12345-123', 'Ava', 'Garcia', '1991-06-27',  'ava.garcia@example.com',
...
VALUES (UUID_TO_BIN('38529bfe-498d-11ee-bbf9-10d0e2fa4154'), UUID_TO_BIN('2c26dd1e-498c-11ee-bbf9-10d0e2fa4154'), 1,  '111122223333', 1, true, 1000.00, 'EUR'),
       (UUID_TO_BIN('3852a1a8-498d-11ee-bbf9-10d0e2fa4154'), UUID_TO_BIN('2c26e002-498c-11ee-bbf9-10d0e2fa4154'), 2, '111122224444', 2, true,
        2500.50, 'EUR'),
       (UUID_TO_BIN('38529f5a-498d-11ee-bbf9-10d0e2fa4154'), UUID_TO_BIN('2c26e124-498c-11ee-bbf9-10d0e2fa4154'),2,  '111122225555', 1, true,
        1500.25, 'EUR'),
       (UUID_TO_BIN('3852a220-498d-11ee-bbf9-10d0e2fa4154'), UUID_TO_BIN('2c26e1c4-498c-11ee-bbf9-10d0e2fa4154'), 1,  '111122226666', 1, true,
        2000.00, 'EUR'),
       (UUID_TO_BIN('3852a02c-498d-11ee-bbf9-10d0e2fa4154'), UUID_TO_BIN('2c26e246-498c-11ee-bbf9-10d0e2fa4154'), 2,  '777722223333', 2, true, 3000.75, 'EUR'),
       (UUID_TO_BIN('3852a298-498d-11ee-bbf9-10d0e2fa4154'), UUID_TO_BIN('2c26e2d2-498c-11ee-bbf9-10d0e2fa4154'), 4, '111122228888', 1, true, 500.00, 'EUR'),
       (UUID_TO_BIN('3852a0b8-498d-11ee-bbf9-10d0e2fa4154'), UUID_TO_BIN('2c26e354-498c-11ee-bbf9-10d0e2fa4154'), 3, '111144443333', 2, true, 700.00, 'EUR'),
       (UUID_TO_BIN('3852a310-498d-11ee-bbf9-10d0e2fa4154'), UUID_TO_BIN('2c26e3d6-498c-11ee-bbf9-10d0e2fa4154'), 4,  '888822223333', 1, false, 1200.00, 'EUR'),
       (UUID_TO_BIN('3852a130-498d-11ee-bbf9-10d0e2fa4154'), UUID_TO_BIN('2c26e462-498c-11ee-bbf9-10d0e2fa4154'), 5,  '999922223333', 2, false,
        800.25, 'USD'),
       (UUID_TO_BIN('3852a3e2-498d-11ee-bbf9-10d0e2fa4154'), UUID_TO_BIN('2c26e4ee-498c-11ee-bbf9-10d0e2fa4154'), 1, '333322223333', 1, false, 3500.00, 'USD');
